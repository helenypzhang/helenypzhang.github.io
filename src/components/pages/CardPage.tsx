                ...
                {config.items.map((item, index) => (
                    ...
                    >
                        <div className="flex justify-between items-start mb-2">
                            {item.link ? (
                                <a href={item.link} target="_blank" rel="noopener noreferrer" className={`${embedded ? "text-lg" : "text-xl"} font-semibold text-primary hover:text-accent transition-colors`}>
                                    {item.title}
                                </a>
                            ) : (
